        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active"><a href="research_output.php" class="nav-link">Research Output</a></li>
    ...
    <div class="container pt-4">
        <div class="row no-gutters slider-text align-items-end">
            <div class="col-md-9 ftco-animate pb-5">
                <h1 class="mb-0 bread">Research Output</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="container pb-5 mb-5">
    ...
    <table class="table table-bordered table-hover text-center text-dark" id="globalRank">
        <thead style="background-color: #4f4e45;width: 100%" class="cell-border table-dark">
        <tr>
            <th>Rank</th>
            <th>Country</th>
            <th>No. of Research Publications</th>
            <th>CAGR %</th>
            <th>Global Share %</th>
        </tr>
        </thead>
    ...
    <div class="row">
        ...
        <div class="col-12 col-md">
            <img src="images/research/FIG1-7.jpg" alt="FIG 1.7" class="img img-thumbnail img-fluid"
                 style="margin-left: auto; margin-right: auto; display: block;">
        </div>
    </div>
    ...
    <table class="table table-bordered table-hover text-center text-dark" id="indiaRank">
        ...
        <tr>
            <th style="text-align: center !important;vertical-align: center;">Subject Area</th>
            <th>Indian Research Publications</th>
            <th>World Research Publications</th>
            <th>India's Global Share (%)</th>
            <th>India's Rank</th>
            <th>India's CAGR (%)</th>
            <th>World's CAGR (%)</th>
        </tr>
