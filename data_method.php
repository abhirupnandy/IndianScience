        ...
        <div class="row">
            <div class="col-lg ftco-animate">
                ...
                <p class="text-justify">
                    The Indian Science Reports portal provides indicators & values about research output, citations,
                    authorship,
                    international collaboration, gender distribution, open access, research grants and social media
                    visibility etc.
                    for the Indian research output during 2010-19. The portal not only present analytical results about
                    Indian
                    research but also compares the values with related values for some other major countries. The portal
                    also
                ...
                <p class="text-justify">
                    ...
                    <a href="https://app.dimensions.ai/discover/publication" style="text-decoration: none"
                       target="_blank">
                        Dimensions</a>
                ...
                <p class="text-justify">
                    ...
                    research
                    paper is considered as an instance of international collaboration if it involves authors from at
                    least
                ...
                <p class="text-justify">
                    ...
                    Based on the value returned by the API, a research paper is categorised as female 1st authored or
                    male
                    1st authored depending on whether the first author is a female or male, respectively. Confidence
                    level of more than 70% is used, i.e. gender determination by API is taken as successful if it
                    returns
                ...
                <p class="text-justify">
                    ...
                    The grants data for both domestic and international funding agencies is obtained and analysed. The
                    open
                ...
                <p class="text-justify">
                    ...
                    <a href="https://link.springer.com/article/10.1007/s11192-021-04188-3"
                       style="text-decoration: none">Lathabai et al. (2021).</a>
