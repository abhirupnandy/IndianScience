...
//Search box value assigning to $Name variable.
		$Name = $_POST['search'];
//Search query.
		$Query = "SELECT DISTINCT concept FROM concepts WHERE concept LIKE '%$Name%' LIMIT 6";
//		$Query = "SELECT concept FROM concepts WHERE concept LIKE '%silver%' ORDER BY TC DESC LIMIT 6";
//Query execution
...
<ul style="list-style-type: none;  padding: 0;margin: 0;">
   ';
		...
		while ($Result = MySQLi_fetch_array($ExecQuery)) {
            ...
            <li onclick='fill("<?php echo $Result['concept']; ?>")'
