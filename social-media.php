    ...
    <div class="container pt-4">
        <div class="row no-gutters slider-text align-items-end">
            <div class="col-md-9 ftco-animate pb-5">
                <h1 class="mb-0 bread">Social Media Visibility</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="container pb-5 mb-5">
    ...
    <table class="table table-bordered table-hover text-cente text-dark" id="sub_alt">
        ...
        <tr>
            <th>Subject</th>
            <th>Altmetric Coverage</th>
            <th>Twitter Coverage</th>
            <th>Average Tweets per paper</th>
            <th>Facebook Coverage</th>
            <th>Average Facebook mentions per paper</th>
            <th>Mendeley Coverage</th>
            <th>Average Mendeley mentions per paper</th>
        </tr>
        </thead>
        <tbody>
        <tr>
