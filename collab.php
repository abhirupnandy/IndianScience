        ...
        <div class="row">
            <div class="col-lg-8 ftco-animate">
                ...
                <p class="text-justify">
                    ...
                    international collaboration. While about 60% of the research output has authors from a single
                    institution,
                    about 15% research output involves domestic collaboration (collaboration between institutions within
                    India).
                    Approximately 20% of the research output involved collaboration at international level. The figure
                    below shows
            ...
            <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
                <div class="sidebar-box ftco-animate">
                    <div class="categories">
                        <h3>Sections</h3>
                        <li><a href="#introduction">Collaboration Patterns <span
                                        class="ion-ios-arrow-forward"></span></a></li>
                        <li><a href="#international">International Patterns<span
                                        class="ion-ios-arrow-forward"></span></a></li>
                        <li><a href="#partners">Major Collaborating Partners<span class="ion-ios-arrow-forward"></span></a>
                        </li>
                        <li><a href="#subject">Subject area-wise Distribution<span class="ion-ios-arrow-forward"></span></a>
                        </li>
...
<div class="container pb-5 mb-5">
    ...
    <p class="text-justify">
        ...
        of the total research output in 2019. Since 2016, the growth in international collaboration is more steep. The
        figure below
        shows the percentage share of internationally collaborated papers in India's research output.
        <br><br>
        <img src="images/collab/FIg-4-1.jpg" alt="FIG 4.1"
             class="img img-thumbnail img-fluid col-12 col-md-8 offset-md-2"
             style="margin-left: auto; margin-right: auto; display: block;width: 100%; height: auto">
        <br><br>
        ...
        output, during 2010 to 2019, involving international collaboration. The table below shows international
        collaboration
    ...
    <br><br>
    <h2 class="mb-3" id="subject">Subject area-wise distribution of domestic and Internationally Collaborated
        papers </h2>
    <p class="text-justify">
        The international collaboration patterns in Indian research output vary across different subject areas. It
        ranges from
        a low of 15.88% in Language, Communication and Culture to 32.55% in Earth Sciences. Subject areas with
        relatively higher international
        collaboration percentage are Physical Sciences (31.67%), Economics (29.44%), Built-Environment and Design
        (28.72%),
        Environmental Sciences (28.69%). The domestic multi-institution collaborated output varies across different
        subject areas.
        For example, Earth Sciences has 24.87% research output as multi-institution collaboration, whereas History and
        Archeology has only
        6.68% of it;s research output involving domestic multi-institutional collaboration. The figure below presents
        the
    ...
    <div class="text-justify small">
        **<b>Subject Codes</b> - 01-Mathematical Science, 02-Physical Sciences, 03-Chemical Sciences, 04-Earth Sciences,
        05-Environmental Sciences,
        06-Biological Sciences, 07-Agricultural and Veterinary Sciences, 08-Information and Computing Sciences,
        09-Engineering,
        10-Technology, 11-Medical and Health Sciences, 12-Built Environment and Design, 13-Education, 14-Economics,
        15-Commerce, Management, Tourism and Services, 16-Studies in Human Society, 17-Psychology and Cognitive
        Sciences,
    ...
    <p class="text-justify">
        The International Collaboration seems to have an advantage in terms of citation impact as compared to domestic
        papers.
        For example, the average citations per paper (ACPP) for domestic papers is <b>7.95</b>, whereas the average
        citation per paper
        for Internationally Collaborated papers is <b>18.65</b>. Similarly, the cited percentage of domestic papers is
        <b>76.75%</b>
        whereas for internationally collaborated papers, it is <b>89%</b>. Further, International Collaboration with
        different
        countries shows different impact, as shown in the figure below. For example, collaboration with Switzerland
        leads to a
