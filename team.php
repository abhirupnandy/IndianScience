    ...
    <div class="container pt-4">
        <div class="row no-gutters slider-text align-items-end">
            <div class="col-md-9 ftco-animate pb-5">
                <h1 class="mb-0 bread">Contributors</h1>
            </div>
        </div>
    </div>
</div>
<h1 class="text-center p-5">Meet the team</h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 offset-lg-3">
                <div class="block-2 ftco-animate">
                    <div class="flipper">
                        <div class="front" style="background-image: url(/images/vivek.jpg);">
                            <div class="box">
                                <h2>Vivek Kumar Singh</h2>
                                <p>Professor,<br>Department of Computer Science,<br>Banaras Hindu University</p>
                            </div>
                        </div>
                        <div class="back">
                            <!-- back content -->
        ...
        <div class="row">
            ...
            <div class="col-lg">
                ...
                <div class="col-lg col-sm-12">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url(/images/team/uploads/mousumi.png);">
                                <div class="box">
                                    <h2>Mousumi Karmakar</h2>
                                    <p>Research Scholar</p>
                                </div>
                            </div>
                            <div class="back">
                ...
                <div class="col-lg col-sm-12">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url(/images/team/uploads/satya.png);">
                                <div class="box">
                                    <h2>Satya Swarup</h2>
                                    <p>Researcher,<br>
                                        Data Analyst at India Health Action Trust</p>
                                </div>
                            </div>
                            <div class="back">
                                <!-- back content -->
                                ...
                                <div class="author d-flex">
                                    <div class="image align-self-center">
                                        <img src="/images/team/uploads/satya.png" alt="">
                                    </div>
                                    <div class="name align-self-center ml-3">Satya Swarup
                                        <span class="position">Researcher,<br>
                                        Data Analyst at India Health Action Trust</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg col-sm-12">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url(/images/team/uploads/aakash.jpg);">
                                <div class="box">
                                    <h2>Aakash Singh</h2>
                                    <p>Research Scholar</p>
                                </div>
