        ...
        <div class="row">
            <div class="col-lg-8 ftco-animate">
                ...
                <p class="text-justify">
                    ...
                    patterns.
                    More precisely, the gender of the first author (leading author) for all the papers, has been
                    determined
                    using the Gender-API service. It is observed that only <b>29.3%</b> of Indian papers are Female
                    1<sup>st</sup> authored,
                    as compared to <b>70.7%</b> Male 1<sup>st</sup> authored papers. The distribution of Female and Male
                    1<sup>st</sup>
                    have remained almost the same during 2010 to 2019 period. The figure below shows the year-wise
                    gender distribution
            ...
            <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
                <div class="sidebar-box ftco-animate">
                    <div class="categories">
                        <h3>Categories</h3>
                        <li><a href="#introduction">Gender Distribution<span class="ion-ios-arrow-forward"></span></a>
                        </li>
                        <li><a href="#sub_dist">Subject area-wise distribution<span
                                        class="ion-ios-arrow-forward"></span></a></li>
                        <li><a href="#collab">International Collaboration<span class="ion-ios-arrow-forward"></span></a>
                        </li>
...
<div class="container pb-5 mb-5">
    ...
    <p class="text-justify">
        The gender distribution of Indian papers are also analysed with respect to different subject areas. While
        majority of
        the 22 subject areas have almost similar percentage of Female 1<sup>st</sup> authored papers, subject areas like
        History & Archaeology, Built Environment & Design and Law & Legal studies have a slightly higher percentage of
        Female 1<sup>st</sup>
        authored papers. In general, only about one-fourth of the research papers in majority of the subject areas have
        Female
        1<sup>st</sup> author. The table below presents percentage of Female and Male 1<sup>st</sup> authored papers in
        different
        subject areas.</p>
    <table id="gender_1"
           class="table table-responsive-sm table-bordered table-hover table-striped text-center text-dark">
    ...
    <h2 class="mb-3" id="collab">International Collaboration patterns in Female and Male 1<sup>st</sup> authored papers
    </h2>
    <p class="text-justify">
        It was analysed whether there exist differences in the propensity for International Collaboration in Female and
        Male
        1<sup>st</sup> authored papers. For this purpose, the proportion of papers that involve international
        collaboration in both the sets
        (Female 1<sup>st</sup> authored and Male 1<sup>st</sup> authored papers) were identified through the 'Country'
        information
        in the Author-affiliation field. It is observed that both Female and Male 1<sup>st</sup> authored papers have
        almost similar
        proportion of papers involving International Collaboration, with the International Collaboration Proportion in
        Female 1<sup>st</sup>
        authored publications increasing from <b>9.47% in 2010</b>
        to <b>23.08% in 2019</b> and International Collaboration Proportion in Male 1<sup>st</sup> authored publications
        increasing
    ...
    <p class="text-justify">
        The citation impact of Female and male 1<sup>st</sup> authored papers are analysed by computing the cited
        percentage (proportion of papers that
        attracted at least one citation) and Average Citations Per Paper for both the sets. It is observed that, in
        general, Female and Male 1<sup>st</sup> authored papers
        have similar cited percentage values during 2010 to 2019 period. Further, the Average Citations per Paper values
        of Female and Male 1<sup>st</sup> authored papers
        are also similar, with very minor variations. The table below shows the year-wise values of cited percentage and
        citations per paper for both
