                    ...
                    <div class="col-lg-8 ftco-animate">
                        ...
                        <p><?php echo $info; ?>
                            ...
                            <a <?php echo 'href="'.$wiki_link.'"';?> target="_blank">
                                <span class="text-dark">Source: Wikipedia (<span class="font-italic">Click for more</span>)</span></a>
                        </p>
                        <hr>
                        <br>
                    ...
                    <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
                        ...
                        <div class="sidebar-box ftco-animate">
                            <div class="categories">
                                ...
                                <li><a href="#research">Research Output and Citations<span class="ion-ios-arrow-forward"></span></a></li>
                                <li><a href="#collab">Authorship and Collaboration<span class="ion-ios-arrow-forward"></span></a></li>
                                <li><a href="#grants">Research Grants<span class="ion-ios-arrow-forward"></span></a></li>
                                <li><a href="#gender">Gender Distribution<span class="ion-ios-arrow-forward"></span></a></li>
                                <li><a href="#open">Open Access Availability<span class="ion-ios-arrow-forward"></span></a></li>
                                <li><a href="#social">Social Media Visibility<span class="ion-ios-arrow-forward"></span></a></li>
                                <li><a href="#sdg">UN SDG related research<span class="ion-ios-arrow-forward"></span></a></li>
                                <li><a href="#thematic">Thematic Structure of Research Output<span class="ion-ios-arrow-forward"></span></a></li>
                                <li><a href="#external">External Data<span class="ion-ios-arrow-forward"></span></a></li>
                            </div>
                        </div>
                    </div>
                </div>
