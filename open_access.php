		...
		<div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active"><a href="open_access.php" class="nav-link">Open Access</a></li>
    ...
    <div class="container pt-4">
        <div class="row no-gutters slider-text align-items-end">
            <div class="col-md-9 ftco-animate pb-5">
                <h1 class="mb-0 bread">Open Access </h1>
            </div>
        </div>
    </div>
</div>
...
<div class="container pb-5 mb-5  pt-0 mt-0">
    <div class="row pt-0 mt-0">
        <div class="col">
            <img src="images/oa/FIG-7-1.jpg" alt="Figure 7.1" class="img img-fluid img-thumbnail">
        </div>
        <div class="col">
            <img src="images/oa/FIG-7-2.jpg" alt="Figure 7.2" class="img img-fluid img-thumbnail">
        </div>
    </div>
    <br><br>
    ...
    <table class="table table-bordered table-hover text-center text-dark" id="oa_major_countries">
        <thead style="background-color: #4f4e45;width: 100%" class="cell-border table-dark">
        <tr>
            <th class="align-top">Country</th>
            <th class="align-top">2010</th>
            <th class="align-top">2011</th>
            <th class="align-top">2012</th>
            <th class="align-top">2013</th>
            <th class="align-top">2014</th>
            <th class="align-top">2015</th>
            <th class="align-top">2016</th>
            <th class="align-top">2017</th>
            <th class="align-top">2018</th>
            <th class="align-top">2019</th>
        </tr>
        </thead>
        <tbody>
        <tr>
